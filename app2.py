...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    # gr.Markdown("""
    # <div style='text-align: center; color: #e91e63;'>
    #     <h1>SummerAIse 🎞️</h1>
    #     <p>Upload a video to Summarize or Search within it</p>
    # </div>
    # """)
    gr.HTML(
        """
    ...
    with gr.Column(elem_id="centered-content"):
        # with gr.Row():
            # gr.Image("assets/logo.png",width=300, height=300, show_label=False, show_download_button=False)    
